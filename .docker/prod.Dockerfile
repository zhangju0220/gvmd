...
FROM forgestash.verify.oepkgs.net/oci-223-community/gvm-libs:${GVM_LIBS_VERSION} AS builder
ARG FEATURE_TOGGLE
...
FROM forgestash.verify.oepkgs.net/oci-223-community/gvm-libs:${GVM_LIBS_VERSION}
